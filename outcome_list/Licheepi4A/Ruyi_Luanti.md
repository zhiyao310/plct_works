...
- 目录
  ...
  - [一、简介](#简介)
  - [二、RuyiSDK 下 GCC 对 LicheePi 4A 的支持测试](#ruyisdk下gcc对licheepi-4a的支持测试)
  - [三、在 Ruyi 虚拟环境下 GCC 对 Cmake 编译的支持测试（以 Luanti 项目为例）](#在ruyi虚拟环境下gcc对cmake编译的支持测试以luanti项目为例)
  - [四、关于虚拟环境中 Ruyi GCC 编译适配的调试](#关于虚拟环境中ruyi-gcc编译适配的调试)
  ## 简介
  测试环境：
  ...
  ---
  ## 在Ruyi虚拟环境下GCC 对开源游戏运行的支持测试(以 Luanti 项目为例）
